...
| --- | --- | --- | --- |
| Discover | Visited `846983349/oth_gf4bk`, `oth_3gbk1`, `oth_bj2k4`; Payout `6748968935/oth_q60ya` | Scope is a visible Global/France/Argentina control; map/list changes only presentation; cards carry status, place, deadline, and one clear action. | A country search field as the primary interaction; treating browsing as proof of nationality; mixing country items into Global. |
...
| Credentials | Vivino `414461255/oth_bm0py`, `oth_d2f3f`; Authenticator `1602061522/oth_9s5pa` | A reusable collection with one active pass, issuer/status/expiry, renewal/replacement actions, and a useful empty CTA. | Presenting the document as an item stored inside Midnight Passport. |
